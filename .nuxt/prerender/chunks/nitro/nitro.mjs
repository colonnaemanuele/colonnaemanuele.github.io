import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, appendResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, getRouterParam, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/radix3/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve, basename, isAbsolute } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/@iconify/utils/lib/index.mjs';
import { consola } from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/consola/dist/index.mjs';
import localAdapter from 'file:///Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/emanuele/Workspace/colonnaemanuele.github.io/server/assets"}];
 ...
 */
const _47Users_47emanuele_47Workspace_47colonnaemanuele_46github_46io_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js = defineDriver((opts) => {
...
storage.mount('internal:nuxt:prerender', _47Users_47emanuele_47Workspace_47colonnaemanuele_46github_46io_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js({"driver":"/Users/emanuele/Workspace/colonnaemanuele.github.io/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js","base":"/Users/emanuele/Workspace/colonnaemanuele.github.io/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emanuele/Workspace/colonnaemanuele.github.io","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/emanuele/Workspace/colonnaemanuele.github.io/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emanuele/Workspace/colonnaemanuele.github.io/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/emanuele/Workspace/colonnaemanuele.github.io/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "dc40deaa-6eb5-4ab4-975b-ba4e65608156",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/emanuele/Workspace/colonnaemanuele.github.io/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "icon": {
...
const _VDLv3G = eventHandler((event) => {
...
const _V6qRC8 = defineCachedEventHandler(async (event) => {
...
const _5q0Fm4 = eventHandler(async (event) => {
...
const _dKXw6m = eventHandler(async (event) => {
...
const _lazy_6nbGC2 = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _VDLv3G, lazy: false, middleware: true, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _V6qRC8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _5q0Fm4, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _dKXw6m, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6nbGC2, lazy: true, middleware: false, method: undefined }
];
